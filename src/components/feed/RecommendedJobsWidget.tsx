...
export function RecommendedJobsWidget({ jobs, isFolded = false }: RecommendedJobsWidgetProps & { isFolded?: boolean }) {
    return (
        <motion.div
            className="bg-white rounded-xl p-4 border border-[#E5E7EB] shadow-sm hover:shadow-md transition-shadow duration-200"
