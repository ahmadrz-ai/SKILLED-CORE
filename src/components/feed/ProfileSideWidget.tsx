...
export function ProfileSideWidget({ user, stats }: ProfileSideWidgetProps) {
    return (
        <div className="bg-white border border-[#E5E7EB] rounded-xl overflow-hidden shadow-sm">
            {/* Cover Banner */}
            <div
                className="h-24 bg-gradient-to-br from-[#5B35D5] via-[#5F3CF8] to-[#4A28C9] relative bg-cover bg-center"
            ...
            >
                ...
                <div className="absolute -bottom-10 left-5">
                    <Avatar className="w-20 h-20 border-4 border-white shadow-lg cursor-pointer transition-transform hover:scale-105 duration-200">
                        ...
                        <AvatarFallback className="bg-[#EAE6FD] text-[#5B35D5] font-bold text-2xl">
                            {user.name?.charAt(0)}
                        </AvatarFallback>
                    </Avatar>
                </div>
            ...
            <div className="py-2.5">
                <div className="px-5 py-2 hover:bg-[#F9FAFB] cursor-pointer transition-colors flex justify-between items-center group">
                    <span className="text-[#6B7280] text-xs font-semibold group-hover:text-[#4A28C9] transition-colors">Profile viewers</span>
                    <span className="text-[#5B35D5] text-xs font-extrabold bg-[#EAE6FD] px-2 py-0.5 rounded-full">{stats.profileViews}</span>
                </div>
                <div className="px-5 py-2 hover:bg-[#F9FAFB] cursor-pointer transition-colors flex justify-between items-center group">
                    <span className="text-[#6B7280] text-xs font-semibold group-hover:text-[#4A28C9] transition-colors">Post impressions</span>
                    <span className="text-[#5B35D5] text-xs font-extrabold bg-[#EAE6FD] px-2 py-0.5 rounded-full">{stats.impressions}</span>
                </div>
            </div>
            ...
            <div className="p-2">
                <button className="w-full flex items-center gap-3 px-3 py-2 text-xs text-[#374151] hover:bg-[#F3F4F6] rounded-lg transition-colors text-left font-semibold group">
                    <Bookmark className="w-4 h-4 text-[#9CA3AF] group-hover:text-[#5B35D5] group-hover:scale-110 transition-all duration-200" />
                    <span>Saved Items</span>
                </button>
                <button className="w-full flex items-center gap-3 px-3 py-2 text-xs text-[#374151] hover:bg-[#F3F4F6] rounded-lg transition-colors text-left font-semibold group">
                    <SquareActivity className="w-4 h-4 text-[#9CA3AF] group-hover:text-[#5B35D5] group-hover:scale-110 transition-all duration-200" />
