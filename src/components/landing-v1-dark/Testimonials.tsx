            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <h2 className="text-5xl md:text-6xl font-heading font-black text-white mb-6">
                        Trusted by Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">Early Community</span>
                    </h2>
                    <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
                        Be among the first to experience a hiring process that actually works.
                    </p>
                </motion.div>
