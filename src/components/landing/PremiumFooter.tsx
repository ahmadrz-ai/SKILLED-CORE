...
export function PremiumFooter() {
    // FIX-013: Auth-aware footer — show different links based on login state
    ...
    const footerLinks = {
        ...
        legal: [
            ...
            // FIX-012: GDPR data deletion link
            { label: "Data Deletion", href: "/legal/data-deletion" }
        ],
        // FIX-013: Only show authenticated routes when logged in
    ...
    const resourceSectionTitle = isLoggedIn ? "Resources" : "Get Started";
        ...
        <footer className="relative border-t border-white/5 bg-black/40 backdrop-blur-xl overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 py-16 relative z-10">
                <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
                    ...
                    {/* FIX-013: Auth-aware Resources/Get Started section */}
                    <div>
                        <h3 className="text-white font-bold text-sm mb-4 uppercase tracking-wider">{resourceSectionTitle}</h3>
                        <ul className="space-y-3">
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <a
                            ...
                            aria-label="SkilledCore on LinkedIn"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="SkilledCore on Instagram"
                            className="w-9 h-9 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 flex items-center justify-center transition-all group"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="SkilledCore on Facebook"
                            className="w-9 h-9 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 flex items-center justify-center transition-all group"
                        >
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="SkilledCore on X (Twitter)"
                            className="w-9 h-9 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 flex items-center justify-center transition-all group"
                        >
