...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, #000000 0%, #1a1a1a 100%)';
                ...
                <section className="pc-card">
                    <div className="pc-inside">
                        ...
                        <div className="pc-content pc-avatar-content">
                            ...
                            {/* User Info / Card Bottom Section */}
                            <div className="pc-user-info">
                                <div className="pc-user-text">
                                    <div className="pc-handle">{companyName}</div>
                                    <div className="pc-status">
                                        INVITE YOU FOR AN INTERVIEW
                                    </div>
                                </div>

                                <div className="w-full my-3 border-t border-white/10"></div>

                                <div className="pc-user-details flex-col !gap-2">
                                    <div className="text-white text-lg font-bold">
                                        {interviewDate}
                                    </div>
                                    <div className="text-zinc-400 text-sm font-mono bg-black/50 px-3 py-1 rounded-full border border-white/10">
                                        {interviewTime}
                                    </div>
                                </div>
